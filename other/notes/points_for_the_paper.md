...
- **Not a few bad years (one sentence).** Marie Curtis was over the limit on 22–60% of days depending on the year, and Sunnyside on 21–47%. In 19 of 20 years both were over the limit more often than every other beach; the exception is 2021, when Kew Balmy (26.9%) passed Sunnyside (24.8%). Source: `other/results/exceedance-by-beach-and-year.csv`.
...
- **Why days in a month are treated as related (a phrase in the method, not a result).** Days over the limit come in runs, so the standard errors treat days in the same month as related (late May counted with June, early September with August). Supporting numbers, if wanted: one day's level correlates with the next at 0.42, and treating every day as independent would make the standard errors about half as wide (median ratio 2.0). The old Poisson figure (8.7) should not be used; see `results_summary.md`.
...
- **Pairwise tests (one sentence; the table in an appendix at most).** Marie Curtis and Sunnyside differ from every other beach but not from each other; 31 of the 45 pairs differ; the other 14 are Marie Curtis and Sunnyside, Centre Island and Kew Balmy, and 12 pairs among the six cleanest beaches.
