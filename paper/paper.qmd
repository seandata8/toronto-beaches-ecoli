...
[Yesterday vs today] Signs based on the previous day's samples were a weak guide to the water on the posting day (@tbl-warning, @tbl-sign-questions). When the "Safe" sign was up, the water was over the limit on 10% of days, and when the "Warning" sign was up, it was under the limit on 63%. Of the posting days with water over the limit, only 37% had a "Warning" sign. A "Warning" sign still made a day over the limit about 3.5 times as likely as a "Safe" sign (37% against 10%).

```{python}
#| label: tbl-warning
#| tbl-cap: "Sign posted at each beach, based on the previous day's samples, against the water on the posting day, 2007 to 2026 (18,998 pairs of consecutive days). A \"Warning\" sign is posted when the previous day's geometric mean was above Toronto's limit of 100 *E. coli* per 100 mL, and a \"Safe\" sign otherwise. Each cell gives the number of pairs and its share of all pairs."
...
#| tbl-cap: "What the sign says about the water on the posting day, 2007 to 2026, derived from the counts in @tbl-warning. The sign is based on the previous day's samples."
#| tbl-colwidths: [85, 15]
#| output: asis
