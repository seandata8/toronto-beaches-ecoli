...
[Yesterday vs today] @tbl-warning compares the sign posted at each beach with the water sampled on the posting day, for 18,998 pairs of consecutive days. The rows give the sign, "Warning" or "Safe", which is based on the previous day's samples; the columns give whether the posting day's water was over or under Toronto's limit. The sign was right on 1,002 days with a "Warning" sign and water over the limit, and on 14,584 days with a "Safe" sign and water under it. It was wrong on 1,712 days with a "Warning" sign and water under the limit, and on 1,700 days with a "Safe" sign and water over it. @tbl-sign-questions gives percentages derived from these counts, as answers to questions a beach-goer might ask.

```{python}
#| label: tbl-warning
#| tbl-cap: "Sign posted at each beach, based on the previous day's samples, against the water on the posting day, for pairs of consecutive days, 2007 to 2026. Each cell gives the number of pairs and its share of all pairs."
